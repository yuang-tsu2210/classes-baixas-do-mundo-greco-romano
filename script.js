function mostrar(secao) {
  ...
  <img class="imagem" src="https://pt.quizur.com/_image?href=https://img.quizur.com/f/img64877494d02c96.57492905.png?lastEdited=1686598841&w=1024&h=1024&f=webp"
    ...
    case "contato":
      c.innerHTML = `
        <h1>Contato</h1>
        <p>Henrique  Cesar  Arthur  Thomaz  Davi Peres
      `;
      break;
    ...
    case "men18":
      c.innerHTML = `
        ...
        <p></p>
        <p>
          <a href="https://pt.quizur.com/trivia/cidadania-mulheres-e-escravos-no-antigo-mundo-greco-romano-1r5yN " target="_blank" rel="noopener"<:>Quiz 
        <p class="creditos"></p>
      `;
      break;
